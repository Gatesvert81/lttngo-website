        ...
        <div className='py-16'>
            ...
            <main className='grid grid-cols-3  justify-items-center'>
                <div className='w-full h-fit flex justify-start items-center' >
                    <Button style="icon" >
                        <Image src="/icons/left-prev.png" alt="previous" layout="fill" className="object-contain" />
                    </Button>
                    <Button style="icon" >
                        <Image src="/icons/right-prev.png" alt="previous" layout="fill" className="object-contain" />
                    </Button>
                </div>
                ...
                <div className='w-full md:h-12 flex justify-end'  >
                    <input type="search" placeholder='Search' className='hidden md:h-12 md:block' />
                    <Button style="icon md:h-full bg-black" >
                        <Image src="/icons/search.png" alt="previous" layout="fill" className="object-contain" />
                    </Button>
                </div>
            </main>
            <section>
            ...
            <SectionText title="Podcast channels">
                Subscribe to our podcast channels to listen to our messages and teachings
            </SectionText>
            <div className='w-full h-fit grid grid-cols-1 md:grid-cols-3 gap-1 px-10 md:px-20 ' >
                <ItemCard icon="spotify.png">
                    lttngo Podcast
                </ItemCard>
                <ItemCard icon="youtube.png">
                    lttngo
                </ItemCard>
                <ItemCard icon="apple-music.png">
                    thelttngopodcast
                </ItemCard>
            </div>
        </div>
