        ...
        <div className='py-16'>
            ...
            <section className='h-fit w-full grid grid-cols-1 md:grid-cols-3 gap-5' >
                <PastorCard name="Ben Fizgeraid" position="Head Pastor, Founder" >
                    To reach and influence the world by building a large Christ-centered, Bible-based church, changing mindsets and empowering people to lead and impact in every spere of life.
                </PastorCard>
                <PastorCard name="Ben Fizgeraid" position="Head Pastor, Founder" >
                    To reach and influence the world by building a large Christ-centered, Bible-based church, changing mindsets and empowering people to lead and impact in every spere of life.
                </PastorCard>
            ...
            <SectionImage title="Come worship with us" btnText="Join Us" route="/contact" >
