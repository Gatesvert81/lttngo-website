  ...
  return (
    <div className="py-16">
      ...
      <SectionText title="LTTNGO is a church that believes in Jesus, a church that loves God and people">
        Life to the Nations Global Outreach (LTTNGO) is a global commission spearheaded by Reverend Joshua Takyi with the mandate to carry the life of God to the nations of the world.
      </SectionText>
      <SectionText>
        The dream is to be realised by the conscious equipping of the believer with the required tools that makes for success as a leader in his jurisdiction.
      </SectionText>

      <section className="h-fit w-full grid grid-cols-1 md:grid-cols-3 gap-5">
        <PastorCard name="Rev. Joshua Takyi" image="pastor-joshua-1.JPG" position="Head Pastor, Founder">
        ...
        <PastorCard name="Sir Paul Dzeha" image="Sir Paul.JPG" position="Head Pastor, Founder">
          To reach and influence the world by building a large Christ-centered,
          Bible-based church, changing mindsets and empowering people to lead
          and impact in every spere of life.
        </PastorCard>
        <PastorCard name="Sir Kwabena" image="Sir Kwabena.JPG" position="Head Pastor, Founder">
          To reach and influence the world by building a large Christ-centered,
          Bible-based church, changing mindsets and empowering people to lead
          and impact in every spere of life.
        </PastorCard>
	...
	image="services/service-writing.JPG"
      >
        Join us on every Tuesday at the UPSA Vice chancellors Complex for our Impact Service where our man of God Shares snippets on what it means to stand out as a leader and bear to touch of hope to the dying world.
      </SectionImage>
    </div>
  );
}
